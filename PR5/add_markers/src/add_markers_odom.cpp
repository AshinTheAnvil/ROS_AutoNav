...
bool is_pick_up_zone()
{
  return get_distance_to(pick_up_pos) < 0.1;
}

bool is_drop_off_zone()
{
...
int main( int argc, char** argv )
{
  ...
  enum State {
    PICKUP,  // Go to pick-up zone
    CARRY,   // go to drop-off zone
    DROP,    // drop off reached
  } state = PICKUP;
